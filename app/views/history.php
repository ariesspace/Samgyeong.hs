<section class="page history-page history-page-simple">
    <section class="history-simple-head">
        <h1>학교 연혁 <span>學校沿革</span></h1>
        <p>
            삼경인문고등학교는 경천, 경인, 경물의 정신을 교육의 중심에 두고
            배움의 깊이와 공동체의 품격을 함께 세워가는 학교를 지향합니다.
        </p>
    </section>
